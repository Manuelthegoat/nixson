# Fairfund Recovery Partners â€” static site

Eight pages, plain HTML + CSS + a little vanilla JS. No build step. Open `index.html`
or serve the folder (`python3 -m http.server`).

```
index.html         Home â€” hero, "first 24 hours" triage strip, services, FAQ, recovery-scam warning
services.html      What we handle â€” five fraud types, plus an explicit "what we don't do"
...
privacy.html       Demo privacy and data-handling page
...
to go â€” company number, licence and registration numbers, fee structure, turnaround
...
3. Write the three linked legal pages â€” privacy policy, terms of engagement, complaints
   procedure â€” and point the footer links at them.
...
exact signals that regulators, banks and search engines use to flag recovery-fraud sites â€”
...
`Fairfund Recovery-recovery-single.html` is the whole site â€” all six pages, inlined CSS and JS â€”
...
`assets/styles.css` and `assets/site.js`. So the six files stay the source of truth â€”
...
and per-page SEO â€” a hash-routed page is one document to a crawler, which matters for
